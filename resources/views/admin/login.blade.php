...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo mb-4">
            <a href="#"><img style="width: 100px;" src="{{ asset('admin_assets/assets/img/logo.png') }}"></a>
        </div>
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="{{ route('admin.login') }}" method="post">
                    ...
                    @if ($errors->has('email'))
                        <p style="color: red;" class="help-block">{{ $errors->first('email') }}</p>
                    @endif
                    <div class="input-group mb-3">
                    ...
                    @if ($errors->has('password'))
                        <p style="color: red;" class="help-block">{{ $errors->first('password') }}</p>
                    @endif
                    <div class="row">
