                    ...
                    <div class="row align-items-center d-flex h-100">
                        <div class="col-md-7">
                            <div class="block">
                                ...
                                <h1 class="mb-3 mt-3">If you love life, don’t waste time, for time is what life
                                    is made up of</h1>
                                <p class="mb-4 pr-5">A repudiandae ipsam labore ipsa voluptatum quidem quae
                                    laudantium quisquam aperiam maiores sunt fugit, deserunt rem suscipit
                                    placeat.</p>
                                <div class="btn-container ">
                                    <a href="appoinment.html" target="_blank" class="btn btn-primary">Contact
                ...
                <div class="container h-100">
                    <div class="row align-items-center d-flex h-100">
                        <div class="col-md-7">
                            <div class="block">
                                <div class="divider mb-3"></div>
                                <span class="text-uppercase text-sm letter-spacing">Leo Tolstoy, War and
                                    Peace</span>
                                <h1 class="mb-3 mt-3">The two most powerful warriors are patience and time.
                                </h1>
                        ...
                        <div class="row align-items-center d-flex h-100">
                            <div class="col-md-7">
                                <div class="block">
                                    ...
                                    <h1 class="mb-3 mt-3">The key is in not spending time, but in investing it.
                                    </h1>
                                    ...
                                    <div class="btn-container ">
                                        <a href="appoinment.html" target="_blank"
                                            class="btn btn-primary">Contact Now <i
        ...
        <div class="row">
            <div class="col-md-6 align-items-center d-flex">
                <div class="about-block">
                    ...
                    <p>This is a great space to write long text about your company and your services. You can
                    ...
                    <div class="card-body p-3">
                        ...
                        <div class="content pt-2">
                            <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                Eligendi ipsum, odit velit exercitationem praesentium error id iusto dolorem
                                expedita nostrum eius atque? Aliquam ab reprehenderit animi sapiente quasi,
                                voluptate dolorum?</p>
                        </div>
