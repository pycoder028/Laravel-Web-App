                    ...
                    <div class="col-lg-6">
                        <div class="text-md-end top-right-bar mt-2 mt-lg-0 call-now">
                            <a href="tel:+23-345-67890">
                                ...
                                <span class="h5">999-XXX-XXXX</span>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarmain">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item active"><a class="nav-link" href="{{ route('index.home') }}">Home</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="{{ route('index.services') }}">View All</a></li>
                            </ul>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('index.faq') }}">FAQ</a></li>
                        <li class="nav-item ">
                            <a class="nav-link " href="{{ route('index.blog') }}">Blog</a>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('index.contact') }}">Contact</a></li>
                    </ul>
                </div>
            </div>
        </nav>
                    ...
                    <div class="widget widget-contact mb-5 mb-lg-0">
                        ...
                        <div class="footer-contact-block mb-4">
                            ...
                            <h4 class="mt-2"><i class="fa-solid fa-envelope"></i> <a
                                    href="mailto:example@example.com">example@example.com</a></h4>
                            <h4 class="mt-2"><i class="fa-solid fa-phone-square" aria-hidden="true"></i> <a
                                    href="tel:+00-000-0000"> +XX-XXX-XXXX</a></h4>
                        </div>
